...
/** 복사 대상(미추적). `BrandLogo`·`CodeAmount` 의 참조 경로와 짝을 맞춘다. */
...
const ASSETS = [
    ...
    ['code-Photoroom.png', 'code.png'], // 코드 화폐 아이콘
]
