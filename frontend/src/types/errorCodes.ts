...
export const ERROR_CODES = {
  ...
  /*
   * 경매 미개시 — SCHEDULED 이고 startAt 미도래 (409). 계약 v1.8 F4 신설분이 미등재였다(FC-049에서 보완).
   * ★ BID_006("마감/종료됨")과 **반드시 분리**한다. 계약 v1.8 주: "'아직 시작 안 함'과 '이미 끝남'은
   *   클라이언트 안내 문구·재시도 가능성이 정반대"다 — 전자는 기다리면 되고 후자는 끝이다.
   *   두 코드를 한 문구로 뭉뚱그리면 사용자가 끝난 경매를 기다리거나, 곧 열릴 경매를 포기한다.
   */
  ...
  /*
   * relocate 대상이 임시보관(TEMP) 상태가 아님 (409). 계약 v1.6 신설분이 미등재였다(FC-054에서 보완).
