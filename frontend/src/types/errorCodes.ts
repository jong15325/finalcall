...
export const ERROR_CODES = {
    ...
    AUTH_009: 'AUTH_009', // 할당 가능한 데모 계정 없음 (503)
    AUTH_011: 'AUTH_011', // 데모 세션에서 허용되지 않은 작업 (403)
    MEMBER_001: 'MEMBER_001', // 닉네임 중복(프로필 수정, §2.5) (409)
    MEMBER_002: 'MEMBER_002', // 진행 중 거래 보유로 탈퇴 불가(§2.5) (409)

    /*
     * 메모/쪽지(§2.6). 발신·조회·삭제에서 각각 다른 안내가 필요해 한 문구로 뭉뚱그리지 않는다 —
     *   수신자 없음=닉네임 확인 / 자기 발신=대상 변경(발신) · 메모 없음·당사자 아님=목록 새로고침(조회·삭제).
     */
    MEMO_001: 'MEMO_001', // 수신자(닉네임) 없음 — 활성 회원 아님(발신) (404)
    MEMO_002: 'MEMO_002', // 메모 없음(존재하지 않는 public_id) (404)
    MEMO_003: 'MEMO_003', // 당사자 아님(남의 메모 열람·삭제, IDOR) (403)
    MEMO_004: 'MEMO_004', // 자기 자신에게 발신 불가 (422)

    // 1:1 채팅(§2.7)
    CHAT_001: 'CHAT_001', // 방/메시지 없음 또는 비당사자 통일 (404)
    CHAT_002: 'CHAT_002', // 대화 상대 없음·비활성 (404)
    CHAT_003: 'CHAT_003', // 자기 자신과 direct room 생성 불가 (422)
    CHAT_004: 'CHAT_004', // 같은 clientMessageId를 다른 본문에 재사용 (409)
    CHAT_005: 'CHAT_005', // 차단 등으로 대화 불가 (409)
    CHAT_006: 'CHAT_006', // 읽음 sequence가 room 범위를 벗어남 (422)
    CHAT_007: 'CHAT_007', // 신고 대상이 상대 발신 메시지가 아님 (422)
    CHAT_008: 'CHAT_008', // 같은 메시지 중복 신고 (409)
    CHAT_009: 'CHAT_009', // 채팅 rate limit 또는 socket quota 초과 (429)
