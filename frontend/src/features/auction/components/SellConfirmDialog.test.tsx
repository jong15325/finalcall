...
function renderDialog(
    overrides: Partial<React.ComponentProps<typeof SellConfirmDialog>> = {},
) {
    const props: React.ComponentProps<typeof SellConfirmDialog> = {
        open: true,
        itemName: '불의 검',
        startPrice: 1000,
        buyNowPrice: 2000,
        endAtLabel: '2026-08-18 12:00:00',
        maxEndAtLabel: '2026-08-18 12:00:00',
        isSubmitting: false,
        submitError: null,
        onClose: vi.fn(),
        onConfirm: vi.fn(),
    ...
    render(<SellConfirmDialog {...props} />)
    return props
}
...
describe('SellConfirmDialog 검토 gate', () => {
