...
function WalletSummaryCard({
    ...
    return (
        <section className="flex h-full flex-col rounded-2xl border border-content-line bg-content-surface p-5 sm:p-6">
            <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                    <h3 className="text-base font-bold text-content-fg">지갑</h3>
                ...
                <button
                    ...
                    aria-disabled="true"
                    title="충전은 준비 중입니다"
                    className="ms-auto rounded-lg bg-content-soft px-3 py-1.5 text-xs font-bold text-content-subtle"
                >
                    충전 준비 중
                </button>
            </div>
            ...
            {isLoading ? (
                <div
                    aria-hidden
                    className="mt-4 h-8 w-40 animate-pulse rounded bg-content-soft"
                />
            ) : isError ? (
                ...
                <>
                    <CodeAmount
                        ...
                        mode="full"
                        className="mt-4 text-2xl font-bold text-content-fg"
                    />
            ...
            <Link
                to={paths.wallet}
                className="mt-4 inline-flex items-center gap-1 self-start text-sm font-semibold text-brand-structure hover:text-control-action-hover"
            >
                지갑 자세히
