            ...
            <div className="flex flex-col p-5 lg:sticky lg:top-24">
                ...
                {!purchasable ? (
                    ...
                    <Link
                        ...
                        className="app-page-action block w-full rounded-lg bg-control-action px-5 py-3.5 text-center text-sm font-bold text-control-action-ink hover:bg-control-action-hover"
                    >
                        로그인하고 구매
                    </Link>
                ) : (
                    <button
                        type="button"
                        data-page-action="primary"
                        className="app-page-action w-full rounded-lg bg-control-action px-5 py-3.5 text-sm font-bold text-control-action-ink hover:bg-control-action-hover"
                        onClick={onBuy}
                    >
                        바로 구매
                    </button>
