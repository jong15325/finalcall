  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className={`h-11 rounded-md border bg-surface px-3 text-base text-text placeholder:text-text-subtle transition-colors duration-fast focus:border-primary ${
