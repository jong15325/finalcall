 ...
 *   하나씩만 보여준다.
 *
 * ★★ **시각 언어는 전부 템플릿이다**(사용자 방침 2026-07-19 — "레이아웃 등 배치 구조만
 *    우리가 정한다"). 우리 팔레트·액센트·CTA 색·활성 표현을 이 셸에 들이지 마라.
 *    색이 필요하면 템플릿 토큰(`--primary` 계열·`gray-*`)과 템플릿 컴포넌트 관례를 쓴다.
 *    **예외는 접근성뿐** — 색 단독 전달 금지(1.4.1)·AA 대비는 템플릿에 위임하지 않는다.
 */
