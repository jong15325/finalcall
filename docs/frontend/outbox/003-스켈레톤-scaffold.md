상태: HOLD — 보류(2026-07-14). 사유: 스켈레톤 기획 = PF 담당으로 재편(user 지시), PF 기획 + 총괄 시퀀싱(outbox/004) 확정 후 재발신. 재발신 시 (1) 로컬 작업 디렉터리에 scaffold 후 완료 시 repo 생성·push, (2) PF 기획 반영으로 본문 갱신 예정.
