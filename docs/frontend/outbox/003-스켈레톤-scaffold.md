상태: HOLD — 보류(2026-07-14). 사유: 스켈레톤 기획 = 기획(P) 담당(D-079로 PF 재통합, 지시 063 인계). 레인 순서·repo 후생성은 총괄 확정(062, (a)). 기획(P) 스켈레톤 기획 완료 보고 후 재발신. 재발신 시 (1) 로컬 작업 디렉터리에 scaffold → DoD 검증 → 완료 시 repo 생성·push, (2) 기획(P) 기획 반영으로 본문 갱신 예정.
