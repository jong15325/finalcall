...
state: done
children: [FC-283, FC-284, FC-285, FC-286, FC-287, FC-288, FC-289, FC-290, FC-291, FC-292, FC-293, FC-294, FC-295, FC-296, FC-300, FC-301, FC-302, FC-303]
gate: null
---
...
- FC-293 → FC-294 → FC-295 → FC-296: navigation 비교·선택 → 운영 AppShell 적용 → 통합 리뷰
...
- 디자인 게이트: 2026-08-13 접점 고정형 navigation 선택 완료.
- 게이트2: 접점 고정형은 API·스키마·token 값·성능 구조를 바꾸지 않는 가역적 geometry 변경이므로 추가 발동 없음.
