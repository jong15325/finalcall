...
./gradlew :backend:bootRun > backend/logs/app.log 2>&1
```
...
설정·변수·컨벤션은 [CLAUDE.md](CLAUDE.md), 단계별 구축 지시는 [docs/backend/references/spring-skeleton-prompts.md](docs/backend/references/spring-skeleton-prompts.md) 참조.
